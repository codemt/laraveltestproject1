        ...
        <h1>  Form Submission </h1>
                  ...
                  <div class="container">
                       ...
                       <form action="multipleform" method="post">
                             ...
                             <div class="row">
                               <div class="col">
                                 <input type="text" name="qty[]"class="form-control" placeholder="First name">
                               </div>
                               <div class="col">
                                 <input type="text" name="qty[]" class="form-control" placeholder="Mobile">
                               </div>
                               <div class="col">
                                 <input type="text" name="qty[]" class="form-control" placeholder="Email(Optional)">
                               </div>
                             </div>
                             <div class="row">
                               <div class="col">
